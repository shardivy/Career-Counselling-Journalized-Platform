...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('superadmin', 'Super Admin'), ('admin', 'Admin'), ('counsellor', 'Counsellor'), ('student', 'Student'), ('parent', 'Parent'), ('basic_user', 'Basic User'), ('ui_ux', 'UI/UX')], max_length=50, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='User',
